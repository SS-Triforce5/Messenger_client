...
class MessengerApp < Sinatra::Base
  ...
  SecureHeaders::Configuration.default do |config|
    ...
    config.csp = {
      ...
      connect_src: %w(wws:),
      img_src: %w('self'),
      font_src: %w('self' https://maxcdn.bootstrapcdn.com http://fonts.googleapis.com/css?family=Open+Sans:300italic,400italic,600italic,700italic,800italic,400,300,600,700,800 http://fonts.googleapis.com/css?family=Merriweather:400,300,300italic,400italic,700,700italic,900,900italic),
      script_src: %w('self' https://code.jquery.com https://maxcdn.bootstrapcdn.com),
      style_src: %w('self' 'unsafe-inline' https://maxcdn.bootstrapcdn.com https://cdnjs.cloudflare.com),      form_action: %w('self'),
